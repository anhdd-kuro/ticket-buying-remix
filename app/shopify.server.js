...
export const shopifyFront = shopifyApi({
  ...
  scopes: ["read_analytics", "write_metaobjects", "read_metaobjects", "write_draft_orders", "read_draft_orders", "write_discounts", "read_discounts", "write_products", "read_products"],
  restResources,
});
